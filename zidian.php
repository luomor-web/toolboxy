...
{"@context": "https://schema.org", "@type": "HowTo", "name": "汉字字典", "step": [{"@type": "HowToStep", "text": "在输入框中输入汉字、词语或成语（最多 10 字）"}, {"@type": "HowToStep", "text": "点击 立即查询 查看每个字的拼音、笔画数、笔顺和组词"}, {"@type": "HowToStep", "text": "输入成语还会显示拼音和释义，结果页可继续查询"}]}
</script>
</head>
<body>
<div class="container">
